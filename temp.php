...
<body>
  <?php
    ...
    $theme_color_form_url = isset($_GET['theme_color']) ? $_GET['theme_color'] : 1;

    // 테마 컬러 설정 - 시트 이미지, url로 설정
    if($theme_color_form_url == 1) {
      $sheet_img = 'sheet_blue.png';
    } else if($theme_color_form_url == 2) {
      $sheet_img = 'sheet_green.png';
    } else if($theme_color_form_url == 3) {
    ...
    $sql = "select theme_color from character_information where num=".$num;
